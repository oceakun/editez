...
export default function SlitSlideout({
  loadingSummary,
  noteId,
  handleFileEditing,
  handleFileDeletion,
  ...
  return (
    <div className="w-full md:w-auto flex flex-row justify-center items-center bg-gradient-to-r from-green-600/10 via-emerald-500/10 to-lime-400/10  py-4 px-4">
      <div className="">
        <button
